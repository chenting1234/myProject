<template>
    <div class="app-container">
        ...
        <div style="margin-bottom: 15px">
            <el-image style="width: 100px; height: 100px" :src="form.avatar2"></el-image>
        </div>
        <el-divider></el-divider>
        ...
        <div style="margin-bottom: 15px">
            <el-image style="width: 50px; height: 50px" :src="form.favicon"></el-image>
        </div>
        <el-divider></el-divider>
        ...
        <div style="margin-bottom: 15px">
            <el-image style="width: 100px; height: 100px" :src="form.qqQrCode2"></el-image>
        </div>
        <el-divider></el-divider>
        ...
        <div style="margin-bottom: 15px">
            <el-image style="width: 100px; height: 100px" :src="form.weixinQrCode2"></el-image>
        </div>
        <el-divider></el-divider>
        ...
        <el-dialog title="请编辑信息" :visible.sync="dialogFormVisible" width="50%" top="5vh" fullscreen>
            <el-form :model="form">
                ...
                <el-form-item label="网站头像地址">
                    ...
                    <Upload :src="form2.avatar" @imgUrl="handleAvatarUrl" />
                </el-form-item>
                ...
                <el-form-item label="QQ 二维码图片地址">
                    ...
                    <Upload :src="form2.qqQrCode" @imgUrl="handleQQimgUrl" />
                </el-form-item>
                <el-form-item label="微信号">
                    <el-input v-model="form2.weixin" @imgUrl="handleWeiXinimgUrl"></el-input>
                </el-form-item>
                <el-form-item label="微信二维码图片地址">
                    <!-- <el-input v-model="form2.weixinQrCode"></el-input> -->
                    <Upload :src="form2.weixinQrCode" />
                </el-form-item>
            </el-form>
...
export default {
    ...
    methods: {
        ...
        confirmEditSetting() {
            this.$API.setting.setSetting(this.form2).then(() => {
        ...
        handleAvatarUrl(url) {
            this.form2.avatar = url;
        },
        handleQQimgUrl(url) {
            this.form2.qqQrCode = url;
        },
        handleWeiXinimgUrl(url) {
            this.form2.weiXin = url;
        }
    },
};
</script>
